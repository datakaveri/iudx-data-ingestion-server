 ...
 * </ul>
 *
 * <p>e.g. <i>java -jar ./fatjar.jar --host $(hostname) -c configs/config.json -m </p>
...
public class Deployer {
  ...
  public static void gracefulShutdown() {
    ...
    logger.debug("The number of verticles that are being removed from the deployment.:"
        + deployIdSet.size());
    // shutdown verticles
  ...
  public static void main(String[] args) {
    CLI cli = CLI.create("IUDX Data Ingestion").setSummary("A CLI to deploy the Data Ingestion")
        .addOption(new Option().setLongName("help").setShortName("h").setFlag(true)
            .setDescription("display help")).addOption(
              new Option().setLongName("config").setShortName("c").setRequired(true)
                .setDescription("configuration file")).addOption(
                  new Option().setLongName("host").setShortName("i").setRequired(true)
                .setDescription("hostname for vertx clustering")).addOption(
                  new TypedOption<String>().setType(String.class).setLongName("modules").setShortName("m")
                .setRequired(false).setDefaultValue("all").setParsedAsList(true).setDescription(
